...
class UserScoreWriteController(
     ...
     */
    @PostMapping("/leaderboard/{leaderboardInstanceId}/user-score")
    suspend fun updateScoreWithFeatures(
        @PathVariable("leaderboardInstanceId") leaderboardInstanceId: String,
        ...
        return try {
            ...
            logger.error("Failed to update score with features for user ${request.userId} in leaderboard ${leaderboardInstanceId}", e)
